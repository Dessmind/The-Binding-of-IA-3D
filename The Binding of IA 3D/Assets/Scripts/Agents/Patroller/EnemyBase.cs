...
public class EnemyBase : MonoBehaviour
{
    ...
    public void TakeDamage(float damage, bool causedByPlayer = false)
    {
        ...
        if (causedByPlayer && damageSound != null)
        {
    ...
    protected virtual void Die(bool causedByPlayer = false)
    {
        if (causedByPlayer && deathSound != null)
        {
